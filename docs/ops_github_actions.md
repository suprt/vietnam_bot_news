...
2. Перейдите в **Settings** → в левом меню найдите:
   - **Secrets and variables** → **Actions** (если доступно)
   - Или **Secrets** (в некоторых версиях интерфейса)
   - Или **Security** → **Secrets and variables**
3. Нажмите **New repository secret** (или **Add secret**)
